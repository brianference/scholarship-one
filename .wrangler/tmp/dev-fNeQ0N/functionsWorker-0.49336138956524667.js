...
// .wrangler/tmp/pages-BSJAbM/functionsWorker-0.49336138956524667.mjs
...
__name2(readSessionId, "readSessionId");
...
__name2(parseSender, "parseSender");
...
var wrap = /* @__PURE__ */ __name2((inner) => `<div style="font-family:system-ui,-apple-system,Segoe UI,sans-serif;max-width:520px;margin:0 auto;color:#2a1c14">
...
__name2(magicLinkHtml, "magicLinkHtml");
var EMAIL_RE = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
...
__name2(extractCatalogIds, "extractCatalogIds");
async function onRequestPost4({ request, env }) {
  const json2 = /* @__PURE__ */ __name2((body, status = 200) => new Response(JSON.stringify(body), {
    status,
...
// .wrangler/tmp/bundle-c5j5fR/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-c5j5fR/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.49336138956524667.js.map
