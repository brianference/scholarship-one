...
**Date:** 2026-07-16T06:51:38.821Z  
**Catalog:** 209  
**Results:** 92 pass · 0 fail · 2 warn · 6 gap · **total 100**
...
| 4 | routes | Nav includes Matches first | **pass** | Matches · Results · Deadlines · Tracker |
| 5 | routes | Nav includes Tracker not Pipeline | **pass** | Matches, Results, Deadlines, Tracker |
| 6 | routes | Landing CTA still hash #results (legacy gap) | **pass** | /matches |
...
| 12 | routes | 6 primary nav items max for mobile UX | **pass** | 4 items |
| 13 | onboard | pins ok: Undergraduate Accounting | **pass** | aicpa,deloitte,efwa-women-accounting,pwc-scholarships,ey-access-potential,kpmg-future-leaders,ima-scholarships,acfe-ritc |
| 14 | onboard | pins ok: Undergraduate Nursing | **pass** | nurse-corps,aacn-nursing,aftercollege-aacn,nln-foundation,nsna-scholarships,aanp-scholarships,oncology-nursing,tylenol-f |
| 15 | onboard | pins ok: Undergraduate Engineering / STEM | **pass** | smart-scholarship,goldwater,swe-scholarships,generation-google,nasa-space-grant,nsf-s-stem,ieee-scholarships,asme-schola |
| 16 | onboard | pins ok: High school senior Black / African Ameri | **pass** | jackie-robinson,ron-brown,ron-brown-extra,jack-and-jill,gates,uncf,nbmbaa,thurgood |
| 17 | onboard | pins ok: Undergraduate Hispanic / Latino / Mexica | **pass** | lulac-scholarship,hsf-athletes,la-raza-scholarships,mexican-american-legal,hispanic,shpe-scholarships,dream-us,alpfa-sch |
| 18 | onboard | pins ok: Undergraduate Computer science Student w | **pass** | google-lime,microsoft-disability,microsoft-scholarship,aahd-krause,incight-scholarship,aapt-disability,mobility-internat |
| 19 | onboard | pins ok: Undergraduate Sports / athletics Women / | **pass** | wsf-grants,csf-college-sports,ncaa-postgrad,naia-scholarships,njcaa-athletics,athlete-network,aicpa,deloitte |
| 20 | onboard | pins ok: Graduate / professional Business | **pass** | kpmg-future-leaders,ama-foundation,aicpa,deloitte,efwa-women-accounting,pwc-scholarships,ey-access-potential,ima-scholar |
| 21 | onboard | pins ok: Community college Need-based | **pass** | jack-kent-transfer,njcaa-athletics,asu-scholarships-office,nsf-s-stem,css-profile-note,fastweb-note,pell,nurse-corps |
| 22 | onboard | pins ok: Undergraduate California First-generatio | **pass** | cal-grant,ca-middle-class,jack-kent-transfer,first-gen-scholars-network,csac-first-gen,illinois-map,florida-fsag,illinoi |
| 23 | onboard | pins ok: Undergraduate | **pass** | jack-kent-transfer,scholarships-com-portal,asu-scholarships-office,nsf-s-stem,daughters-american-nursing,women-of-the-el |
| 24 | onboard | pins ok: High school senior Accounting Women / fe | **pass** | aicpa,deloitte,efwa-women-accounting,forte-future-leaders,afwa-foundation,society-women-accountants,ascpa-women,ey-acces |
...
| 29 | onboard | DACA query finds dream-us | **pass** | dream-us,hispanic-scholarship-directory |
| 30 | onboard | profile labels human not enums | **pass** | High school senior Computer science |
| 31 | onboard | Bare undergrad pins not all state grants | **pass** | state=0/8 |
| 32 | search | matchCatalog: handicapped student track math | **pass** | google-lime,microsoft-scholarship,special-olympics-athlete,adaptive-sports-usa,microsoft-disability |
| 33 | search | matchCatalog: nursing undergrad | **pass** | nurse-corps,aacn-nursing,aftercollege-aacn,nln-foundation,nsna-scholarships |
| 34 | search | matchCatalog: Undergraduate Accounting | **pass** | aicpa,deloitte,ascpa-women,efwa-women-accounting,pwc-scholarships |
| 35 | search | matchCatalog: Black woman marketing | **pass** | nbmbaa,uncf,thurgood,united-negro-college,naba-scholarships |
| 36 | search | matchCatalog: Mexican Latina sports | **pass** | hsf-athletes,ncaa-ethnic-minority,lulac-scholarship,la-raza-scholarships,hispanic |
| 37 | search | matchCatalog: Florida high school merit | **pass** | bright-futures-fl,florida-fsag,cocacola,jack-kent,wsf-grants |
| 38 | search | matchCatalog: STEM engineering undergrad | **pass** | smart-scholarship,goldwater,swe-scholarships,generation-google,nasa-space-grant |
| 39 | search | matchCatalog: community college transfer need | **pass** | jack-kent-transfer,njcaa-athletics,illinois-map,florida-fsag,illinois-aim-high |
| 40 | search | matchCatalog: first generation high school need | **pass** | dell-scholars,horatio-alger,burger-king-scholars,questbridge,pos-se |
| 41 | search | matchCatalog: LGBTQ scholarships undergrad | **pass** | point-foundation,out-to-innovate,ama-foundation,aicpa,swe-scholarships |
...
| 47 | filter | onlyAi respects pins | **pass** | 8 |
| 48 | filter | listFilter nursing narrows | **pass** | 209→18 |
| 49 | filter | every browse category has items or is all | **pass** | 16 cats |
| 50 | filter | urgency soon only fixed ≤45d | **pass** | n=0 |
| 51 | filter | amount under-5k rough | **pass** | 12 |
...
| 57 | ai | Chat context has catalog + no invent | **pass** | bytes≈74622 |
...
| 79 | ux | GAP: compare panel only on Results | **pass** | compare on Matches |
| 80 | ux | GAP: runSearch pins skip identity/senior filters | **pass** | filtered |
| 81 | ux | Catalog size ≥ 50 | **pass** | 209 |
