...
| 4 | onboarding | HS + Black — Ron Brown strong + pinned | **pass** | rb=54 pins=jackie-robinson,ron-brown,gates,uncf,nbmbaa,thurgood,nsbe-scholarships,nbna-scholarships |
| 5 | onboarding | HS + women + accounting — no sports field false match | **pass** | wsf=6 aicpa=74 |
| 6 | onboarding | Undergrad does not pin Coca-Cola / Dell / Elks | **pass** | pins=jack-kent-transfer,asu-scholarships-office,fastweb-note,pell,nurse-corps,illinois-map,florida-fsag,illinois-aim-high |
| 7 | onboarding | Grad student — HS senior entry low | **pass** | cocacola=0 |
| 8 | onboarding | Community college — transfer awards preferred over senior entry | **pass** | pins=jack-kent-transfer,asu-scholarships-office,fastweb-note,pell,nurse-corps,illinois-map,florida-fsag,illinois-aim-high |
| 9 | onboarding | California undergrad first-gen need — Cal Grant ranked | **pass** | cal=82 pins=cal-grant,ca-middle-class,jack-kent-transfer,illinois-map,florida-fsag,illinois-aim-high,wa-college-grant,ohio-ocog |
| 10 | onboarding | Hispanic undergrad — Hispanic pins, not Ron Brown | **pass** | hispanicPins=lulac-scholarship,hsf-athletes,la-raza-scholarships,hispanic,shpe-scholarships,dream-us,acs-scholars |
| 11 | onboarding | Disability undergrad — disability awards pin | **pass** | dis=google-lime,microsoft-disability,aahd-krause,incight-scholarship,nfb-scholarship |
| 12 | onboarding | Sports major + women — WSF can rank well | **pass** | wsf=92 |
| 13 | onboarding | Nursing undergrad — nursing not STEM-only noise | **pass** | nurse=nurse-corps,aacn-nursing,aftercollege-aacn |
...
| 15 | onboarding | Empty-ish undergrad any/any still gets non-empty pins | **pass** | count=8 jack-kent-transfer,scholarships-com-portal,asu-scholarships-office,fastweb-note,pell,smart-scholarship,nurse-corps,illinois-aim-high |
| 16 | search | Header: handicapped student track math → disability hits | **pass** | google-lime,microsoft-disability,aahd-krause,incight-scholarship,nfb-scholarship,goldwater,ncaa-postgrad,smart-scholarship |
...
| 18 | search | Nursing undergrad query tops nursing awards | **pass** | aacn-nursing,aftercollege-aacn,nurse-corps,ama-foundation,aicpa |
| 19 | search | Mexican Latina sports — sports/hispanic present | **pass** | hsf-athletes,lulac-scholarship,la-raza-scholarships,dream-us,hispanic,wsf-grants,shpe-scholarships,acs-scholars |
| 20 | search | Black woman marketing — business/black present | **pass** | black=5 biz=4 |
| 21 | search | DACA query hits dream-us or undoc tags | **pass** | dream-us |
...
| 25 | search | STEM search does not top pure nursing without stem tags | **pass** | swe-scholarships,smart-scholarship,goldwater,generation-google,ama-foundation,aicpa |
| 26 | search | State: Florida bright futures appears for Florida query | **pass** | bright-futures-fl,florida-fsag,cocacola,jack-kent,wsf-grants,dell-scholars,horatio-alger,elks-mvs |
...
| 32 | filter | listFilter nursing narrows results | **pass** | 82→4 |
| 33 | filter | category nursing matches nursing tags | **pass** | n=5 |
| 34 | filter | amount bucket under-5k excludes huge awards when parseable | **pass** | under-5k count=3 |
| 35 | filter | onlyShort respects shortlist | **pass** | aicpa,deloitte |
| 36 | filter | sort by deadline puts fixed dates before far rolling preference | **pass** | n=82 first=gates |
...
| 41 | ai | Chat context includes full catalog + profile | **pass** | ctx bytes≈31764 |
| 42 | ai | Canned STEM prompt matchCatalog grounded | **pass** | swe-scholarships,generation-google,smart-scholarship,goldwater |
